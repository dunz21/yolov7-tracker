...
def process_pipeline(csv_box_name='', video_path='', img_folder_name='',client_id='',store_id='',video_date='',start_time_video='',frame_rate=''):
    ...
    print("Step 1: Convert CSV to SQLite")
    ...
    # print(f"Step 1 completed: Converted {csv_box_name}.csv to SQLite database at {db_base_path}")
    
    # # Step 2: Correct IDs in the database using the switch ID corrector pipeline
    # # print("Step 2: Correct IDs in the database using the switch ID corrector pipeline")
    ...
    # # print(f"Step 2 completed: Corrected IDs using switch ID corrector pipeline")
    
    # # Step 3: Prepare data for image selection
    # print("Step 3: Prepare data for image selection")
    ...
    # print(f"Step 3 completed: Prepared data for image selection")
    
    # # Step 4: Predict image selection
    # print("Step 4: Predict image selection")
    # predict_img_selection(db_file_path=db_base_path, model_weights_path='mini_models/results/image_selection_model.pkl')
    # print(f"Step 4 completed: Predicted image selection")
    
    # # Step 5: Clean image folder by selecting top-k images
    # print("Step 5: Clean image folder by selecting top-k images")
    ...
    # print(f"Step 5 completed: Cleaned image folder and selected top-k images")
    
    # # Step 6: Extract features from model
    # print("Step 6: Extract features from model")
    ...
    print(f"Step 9 completed: Saved visits per hour to MySQL")
    
    # Step 10: Extract short visits
    print("Step 10.1: Extract short visits")
    short_visits_clips = extract_short_visits(video_path=video_path, db_path=db_base_path)
    print(f"Step 10.1 completed: Extracted short visits")
    
    # Step 11: Process clips to S3
    print("Step 10.2: Process clips to S3")
    ...
    print(f"Step 10.2 completed: Processed clips to S3")
    
    # Step 12: Save short visits to MySQL
    print("Step 10.3: Save short visits to MySQL")
    ...
    print(f"Step 10.3 completed: Saved short visits to MySQL")
    
    print("Process pipeline completed successfully")
