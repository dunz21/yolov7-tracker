...
def get_video_data():
    ...
    data= [
        ...
        {
            'name' : "diponti_estado",
            'source' : "/home/diego/mydrive/DiPonti_Estado_Videos_Raw/estado_entrada_2024_06_01_09_00_06.mkv",
            'description' : "",
            'folder_img' : "imgs",
            'polygons_in' : np.array([[730,351],[1030,358],[1030,412],[730,407]], np.int32),
            'polygons_out' : np.array([[740,300],[1030,305],[1030,358],[730,351]], np.int32),
            'polygon_area' : np.array([[720,273],[1038,290],[1093,467],[677,459]], np.int32),
        },
        {
            ...
            'polygons_in' : np.array([[512,241],[658,245],[706,269],[460,266]], np.int32),
            'polygons_out' : np.array([[508,215],[645,221],[658,245],[512,241]], np.int32),
            'polygon_area' : np.array([[464,155],[441,282],[726,303],[696,168]], np.int32),
        },
        {
            'name' : "calper_portugal_escalera",
            'source' : "/home/diego/Documents/Footage/calper/portugal_20240424.mp4",
            'description' : "Video de Santos Dumont",
            'folder_img' : "imgs_calper_portugal",
            'polygons_in' : np.array([[512,241],[658,245],[706,269],[460,266]], np.int32),
